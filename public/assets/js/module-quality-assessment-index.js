 ...
 *
 */
var idUrl = 'module-quality-assessment';
var idForm = 'module-quality-assessment-form';
var className = 'ModuleQualityAssessment';
var inputClassName = 'mikopbx-module-input';
/* global globalRootUrl, globalTranslate, Form, Config */

var ModuleQualityAssessment = {
  $formObj: $('#' + idForm),
  ...
  validateRules: {
    textField: {
      ...
      rules: [{
        type: 'empty',
        prompt: globalTranslate.module_quality_assessmentValidateValueIsEmpty
      }]
    },
    areaField: {
  ...
  changeStatus: function changeStatus(status) {
    switch (status) {
      case 'Connected':
        ...
        window[className].$moduleStatus.html(globalTranslate.module_quality_assessmentConnected);
        break;

      case 'Disconnected':
        window[className].$moduleStatus.removeClass('green').removeClass('red').addClass('grey');
        window[className].$moduleStatus.html(globalTranslate.module_quality_assessmentDisconnected);
        break;

      case 'Updating':
        window[className].$moduleStatus.removeClass('green').removeClass('red').addClass('grey');
        window[className].$moduleStatus.html("<i class=\"spinner loading icon\"></i>".concat(globalTranslate.module_quality_assessmentUpdateStatus));
        break;
...
//# sourceMappingURL=module-quality-assessment-index.js.map
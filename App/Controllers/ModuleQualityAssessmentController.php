...
{
    private $moduleUniqueID = 'ModuleQualityAssessment';
    private $moduleDir;
    ...
    public function indexAction(): void
    {
        ...
        $footerCollection->addJs("js/cache/{$this->moduleUniqueID}/module-quality-assessment-index.js", true);
        $footerCollection->addJs('js/vendor/jquery.tablednd.min.js', true);

        // Add CSS files to the header collection
        $headerCollectionCSS = $this->assets->collection('headerCSS');
        $headerCollectionCSS->addCss("css/cache/{$this->moduleUniqueID}/module-quality-assessment.css", true);
        ...
        $this->view->form = new ModuleQualityAssessmentForm($settings, $options);
    ...
    public function saveAction() :void
    {
        ...
        $record = ModuleQualityAssessment::findFirst();
        if ($record === null) {
            $record = new ModuleQualityAssessment();
        }
        $this->db->begin();
    ...
    private function getClassName($tableName):string
    {
        ...
        $className = "Modules\ModuleQualityAssessment\Models\\$tableName";
